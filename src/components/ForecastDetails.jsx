...
export default function ForecastDetails({ data }) {
  const renderMoonPhase = moonPhase.find((el) => {
    return el.title === data.astro.moon_phase;
  });
      ...
      <Box>
        ...
        <Stack>
          ...
          >
            ...
            >
              <img
                src={renderMoonPhase.value}
                className="icon"
                alt={data.astro.moon_phase}
              />
              <Stack>
                <p>Moon Phase</p>
